...
You need to form your opinion around the subject. I’m not advocating for one technology over another, just presenting all the opportunities and tools you have at your disposal.
...
![](https://thevalleyofcode.com/images/jwt/jwt-api-authentication.png)
...
In this case, the client needs to store the token somewhere. Where is the best place? In an **HttpOnly cookie**. The other methods are all prone to [XSS](https://thevalleyofcode.com/xss/) attacks and as such they should be avoided. An HttpOnly cookie is not accessible from JavaScript, and is automatically sent to the origin server upon every request, so it perfectly suits the use case.
...
- [The JWT Debugger](https://jwt.io/#debugger)
...
- [Stop using JWT for sessions, part 2: Why your solution doesn’t work](http://crypto.net/~joepie91/blog/2016/06/19/stop-using-jwt-for-sessions-part-2-why-your-solution-doesnt-work/)

---
title: "Linux Basics: The UNIX Filesystem Commands"
...
Clipped from: [https://flaviocopes.com/unix-filesystem/](https://flaviocopes.com/unix-filesystem/)
...
Every modern computer system relies on a filesystem to store and retrieve programs. Not everything can be kept in memory, which is a precious and limited resource, and we need a safe place to store data when the computer restarts or is shut off. Memory is completely wiped off any time the computer restarts, while the disk structure is persistent.
...
- `/opt` user programs
- `/proc` used by kernel and processes (not existing on macOS)
- `/root` the home folder of the root user (not existing on macOS)
- `/run` (not existing on macOS)
- `/sbin` system binaries used for booting the system
- `/tmp` temporary files
...
![](https://thevalleyofcode.com/images/unix-filesystem/Screenshot_2019-02-09_at_18.50.14.png)
...
![](https://thevalleyofcode.com/images/unix-filesystem/Screenshot_2019-02-09_at_18.49.52.png)

Compared to plain `ls`, it returns much more information.
...
This set of data is generated by the `l` option. The `a` option also shows hidden files.
...
![](https://thevalleyofcode.com/images/unix-filesystem/Screenshot_2019-02-09_at_19.26.02.png)
...
I mentioned permissions briefly before, when I introduced the `ls -al` command.
...
![](https://thevalleyofcode.com/images/unix-filesystem/Screenshot_2019-02-10_at_09.11.05.png)
...
![](https://thevalleyofcode.com/images/unix-filesystem/Screenshot_2019-02-10_at_09.57.13.png)

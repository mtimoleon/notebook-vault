...
Κατά το import να κάνει merge, δηλαδή αν υπάρχει δεν το πειράζει κι αν δεν υπάρχει τότε το βάζει. Πχ στο facility αν υπάρχει το equipment δεν το ακουμπάς
